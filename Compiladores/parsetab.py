...
_lr_productions = [
  ...
  ('inicio -> INT MAIN LPAREN RPAREN blocoprincipal','inicio',5,'p_inicio','parser.py',85),
  ('blocoprincipal -> LBRACES corpo RBRACES SEMICOLON','blocoprincipal',4,'p_blocoprincipal','parser.py',90),
  ('corpo -> comando','corpo',1,'p_corpo','parser.py',94),
  ('corpo -> corpo comando','corpo',2,'p_corpo','parser.py',95),
  ('comando -> declaracoes','comando',1,'p_comando','parser.py',98),
  ('comando -> atribuicao','comando',1,'p_comando','parser.py',99),
  ('comando -> bloco_if','comando',1,'p_comando','parser.py',100),
  ('comando -> bloco_while','comando',1,'p_comando','parser.py',101),
  ('comando -> bloco_for','comando',1,'p_comando','parser.py',102),
  ('operadores_comparativos -> LT','operadores_comparativos',1,'p_operadores_comparativos','parser.py',105),
  ('operadores_comparativos -> LE','operadores_comparativos',1,'p_operadores_comparativos','parser.py',106),
  ('operadores_comparativos -> GT','operadores_comparativos',1,'p_operadores_comparativos','parser.py',107),
  ('operadores_comparativos -> GE','operadores_comparativos',1,'p_operadores_comparativos','parser.py',108),
  ('operadores_comparativos -> NE','operadores_comparativos',1,'p_operadores_comparativos','parser.py',109),
  ('operadores_comparativos -> EQUALS','operadores_comparativos',1,'p_operadores_comparativos','parser.py',110),
  ('declaracao_linha -> tipo operadores_comparativos values','declaracao_linha',3,'p_declaracao_linha','parser.py',114),
  ('declaracao_linha -> tipo ID operadores_comparativos ID','declaracao_linha',4,'p_declaracao_linha','parser.py',115),
  ('declaracoes -> tipo ID SEMICOLON','declaracoes',3,'p_declaracoes','parser.py',118),
  ('declaracoes -> tipo ID EQUALS values SEMICOLON','declaracoes',5,'p_declaracoes','parser.py',119),
  ('declaracoes -> tipo ID EQUALS ID SEMICOLON','declaracoes',5,'p_declaracoes','parser.py',120),
  ('atribuicao -> ID EQUALS ID SEMICOLON','atribuicao',4,'p_atribuicao','parser.py',129),
  ('atribuicao -> ID EQUALS values SEMICOLON','atribuicao',4,'p_atribuicao','parser.py',130),
  ('bloco_if -> IF LPAREN declaracoes RPAREN LBRACES corpo RBRACES SEMICOLON','bloco_if',8,'p_bloco_if','parser.py',142),
  ('bloco_while -> WHILE LPAREN declaracoes RPAREN LBRACES corpo RBRACES SEMICOLON','bloco_while',8,'p_bloco_while','parser.py',146),
  ('bloco_for -> FOR LPAREN condicao_for RPAREN LBRACES corpo RBRACES SEMICOLON','bloco_for',8,'p_bloco_for','parser.py',150),
  ('condicao_for -> declaracao_linha SEMICOLON ID operadores_comparativos values','condicao_for',5,'p_condicao_for','parser.py',154),
  ('condicao_for -> declaracao_linha SEMICOLON values operadores_comparativos ID','condicao_for',5,'p_condicao_for','parser.py',155),
  ('tipo -> INT','tipo',1,'p_tipo','parser.py',158),
  ('tipo -> FLOAT','tipo',1,'p_tipo','parser.py',159),
  ('tipo -> CHAR','tipo',1,'p_tipo','parser.py',160),
  ('values -> INTEGER','values',1,'p_values','parser.py',164),
  ('values -> STRING','values',1,'p_values','parser.py',165),
  ('values -> FLOATN','values',1,'p_values','parser.py',166),
  ('values -> ID','values',1,'p_values','parser.py',167),
]
